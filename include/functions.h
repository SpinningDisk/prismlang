/******************************************************************************
  * @file           : functions.h
  * @brief          : includes basic functions frequently used elsewhere
  ******************************************************************************
*/
...
typedef struct __attribute__((packed)){ int sign: 1; unsigned int exp: 8;   unsigned int man: 23;   }f8_23_float;
